...
public class UserServiceImpl implements UserService {
    ...
    public UserServiceImpl(UserRepository repo, PasswordEncoder passwordEncoder, JWTService jwtService) {
        ...
        User admin = new User("admin", this.passwordEncoder.encode("admin"), UserProfile.ADMIN);
	...
	public User createUser(NewUser newUser) {
		...
		return repo.save(new User(newUser.getUsername(), newUser.getPassword(), UserProfile.ADMIN));
	}
